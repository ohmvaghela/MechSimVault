...
class Comments(models.Model):
  ...
  simulation_id = models.ForeignKey("simulations.Simulation", verbose_name="simulation_id", on_delete=models.CASCADE)
  ...
  def __str__(self):
    return f"Comment on {self.simulation_id.title} on {self.simulation_id.user_id.email}" 
